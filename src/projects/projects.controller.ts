...
export class ProjectsController {
  ...
  async createTaskFieldValue(@Body() createTaskFieldValuedDto: TasksFieldValueDto,
  @Req() req: Request, @Param('taskFieldId') taskFieldId: string) {
    // @ts-expect-error
    return await this.projectsService.createTaskFieldValue(createTaskFieldValuedDto, req.user.id, +taskFieldId);
  }
  ...
  @Req() req: Request, @Param('taskFieldId') taskFieldId: string) {
    // @ts-expect-error
    return await this.projectsService.updateTaskFieldValue(updateTaskFieldValuedDto, req.user.id, +taskFieldId);
  }
